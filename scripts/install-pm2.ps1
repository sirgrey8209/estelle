...
Write-Host "=== Estelle PM2 Setup ===" -ForegroundColor Cyan
...
Write-Host "`n[3/4] Starting Estelle Pylon..." -ForegroundColor Yellow
...
PM2 Commands:
  ...
  pm2 logs estelle-pylon  # View logs
